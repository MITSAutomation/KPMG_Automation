...
public class Keywords {
	...
	// Open browser
	public String openBrowser(String object, String data) throws IOException,
...
if (os.contains("Windows")) {
	...
	public  String mouseHover1(String object,String data){
	       ...
	       try{
	    	   WebElement ProductImage = driver.findElement(By.cssSelector("section.image_block[data-prod='"+ProdutType+"']"));
			   ...
			   WebElement GreenTick = driver.findElement(By.xpath("//*[@id='personalize-"+productidvalue+"-UNDEFINED-false']"));
	...
	public  String getTextStore(String object, String data){
	       ...
	       try{
	    	   ...
	    	   currentTestSuiteXLS.setCellData(currentTestCaseName,
						currentExcellColumnName, currentTestDataSetID, actualTitle);
...
// ********************************** AccuCoonect Project related Methods *****************************************
	...
	/*public String EnterDataWithKeywords(String object,String data)
	 {
	  try{
	...
	/*public String sikulihover(String object,String data)
	{
		Screen s=new Screen();
		try {
			s.hover(data);
	...
	public String selectdropdownbytext(String object, String data) {
		...
		try {
			...
			//Select select = new Select(By.xpath("//*[@id='divCategory']/ul/span/span").tagName("Option"));
			...
			return Constants.KEYWORD_FAIL
					+ " Unable to select value from dropdown" + e.getMessage();
	...
	public String selectdropdownbyindex(String object, String data) {
		...
		try {
			...
			new Select(driver.findElement(By.xpath(object)))
					.selectByIndex(index);
	...
	/*public String store_value(String object, String data) {
		...
		try {
			String actual = driver
					.findElement(By.xpath(object)).getText();
			System.out.println("test:"+actual);
			APP_LOGS.debug("actual..."+actual);
			currentTestSuiteXLS.setCellData(currentTestCaseName,
					currentExcellColumnName, currentTestDataSetID, actual);

		} catch (Exception e) {
			APP_LOGS.debug("Store value Method End");
			return Constants.KEYWORD_FAIL + " Unable to Store value in excell"
					+ e.getMessage();
	...
	//geting current date with time 
		public String VariablewithDate(String object, String data) {
			...
			try {
				...
				return Constants.KEYWORD_FAIL + "Error -->Count not matched"
						+ e.getMessage();
			}
			APP_LOGS.debug("Adding date extention Method End");
		...
		public String StringCon(String object[], String data[]) {
			...
			currentTestSuiteXLS.setCellData(currentTestCaseName,
					currentExcellColumnName, currentTestDataSetID, s);
